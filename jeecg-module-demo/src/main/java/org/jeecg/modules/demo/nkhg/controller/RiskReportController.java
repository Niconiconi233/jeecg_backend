package org.jeecg.modules.demo.nkhg.controller;
...
import org.jeecg.modules.demo.nkhg.entity.RiskReport;
import org.jeecg.modules.demo.nkhg.service.IRiskReportService;
...
@Api(tags="风险报送")
@RestController
@RequestMapping("/nkhg/riskReport")
@Slf4j
public class RiskReportController extends JeecgController<RiskReport, IRiskReportService> {
	...
	@RequiresPermissions("nkhg:risk_report:add")
	...
	@RequiresPermissions("nkhg:risk_report:edit")
	...
	@RequiresPermissions("nkhg:risk_report:delete")
	...
	@RequiresPermissions("nkhg:risk_report:deleteBatch")
    ...
    * @param riskReport
    */
    @RequiresPermissions("nkhg:risk_report:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("nkhg:risk_report:importExcel")
